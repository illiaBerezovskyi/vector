...
const sections = [
  {
    ...
    body: [
      'Цей документ є офіційною публічною офертою ФОП Мельничука Романа Петровича (далі — «Виконавець») укласти договір про надання послуг на умовах, викладених нижче.',
  ...
  },
  {
    ...
    body: [
      'ФОП МЕЛЬНИЧУК РОМАН ПЕТРОВИЧ',
      'ЄДРПОУ / РНОКПП: 3937013891',
      'Адреса реєстрації: Україна, 10001, Житомирська обл., м. Житомир, вул. Огієнка Івана, буд. 14, кв. 1',
      'Банківські реквізити: АТ «А-БАНК», IBAN UA273077700000026004011255941 (UAH)',
      'Телефон: +38 (091) 481-17-91 · Email: guteroma555@gmail.com · Telegram: @roma00q',
    ],
  },
]
